...
import { C as Instagram, d as Send, k as Check, x as Mail } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/contact-B-Fba4RW.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								...
								className: "flex items-center gap-3 text-foreground hover:text-[var(--orange)]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Instagram, { size: 18 }), " @cruizrapp on Instagram"]
							}) })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
