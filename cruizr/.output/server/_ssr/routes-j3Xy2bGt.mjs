...
import { N as ArrowRight, O as ChevronDown, S as Lock, b as MapPin, i as Users, l as ShieldCheck, o as Trophy, p as Radio } from "../_libs/lucide-react.mjs";
...
var app_mockup_default = "/assets/app-mockup-mF32xL68.jpg";
...
var liveintercom_default = "/assets/liveintercom-z0EatGV3.png";
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
					...
					title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Find Answers to ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-gradient",
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionTrigger, {
										className: "text-base font-semibold hover:text-[var(--orange)] md:text-lg",
										children: "What is the best app for motorbike clubs and group motorcycle rides?"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionContent, {
										className: "text-muted-foreground leading-relaxed text-sm md:text-base",
										children: "CRUIZR is built to be the ultimate app for motorbike clubs and group rides. By replacing scattered WhatsApp chats, CRUIZR acts as a unified platform where communities can schedule events, monitor rider safety, enforce accountability, and use hands-free intercom communication on the go."
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
									value: "item-2",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionTrigger, {
										className: "text-base font-semibold hover:text-[var(--orange)] md:text-lg",
										children: "How does CRUIZR ensure rider safety and group tracking?"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionContent, {
										className: "text-muted-foreground leading-relaxed text-sm md:text-base",
										children: "Rider safety and accountability are core to CRUIZR. The app features a live group GPS tracker to ensure no one gets lost, automatic crash alerts, emergency SOS triggers, and a unique meetup verification system. These tools help groups ride safely on highways, off-road trails, and city streets."
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
									value: "item-4",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionTrigger, {
										className: "text-base font-semibold hover:text-[var(--orange)] md:text-lg",
										children: "How does the app support seasonal trips like monsoon or winter rides?"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionContent, {
										className: "text-muted-foreground leading-relaxed text-sm md:text-base",
										children: "CRUIZR is built for all seasons. Riders can list monsoon bike rides in India, find off-road runs in the rain, or organize winter tour routes. The community-sourced route planner alerts you to road hazards, water-logged tracks, and safe shelters, making seasonal exploration seamless."
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccordionItem, {
									value: "item-6",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionTrigger, {
										className: "text-base font-semibold hover:text-[var(--orange)] md:text-lg",
										children: "Which major cities in India are supported by CRUIZR?"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionContent, {
										className: "text-muted-foreground leading-relaxed text-sm md:text-base",
										children: "CRUIZR supports riding communities nationwide, with active hubs in Bangalore, Mumbai, Pune, Hyderabad, Chennai, Delhi NCR, and Kolkata. Whether you want to plan weekend trips, discover urban biker hangouts, or run group safety audits, CRUIZR connects local riders near you."
									})]
								})
							]
						})
