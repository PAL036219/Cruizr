...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.cruizr.in/terms" },
      { property: "og:image", content: "https://www.cruizr.in/assets/hero-riders.jpg" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Terms of Service — CRUIZR" },
      { name: "twitter:description", content: "CRUIZR terms of service." },
      { name: "twitter:image", content: "https://www.cruizr.in/assets/hero-riders.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://www.cruizr.in/terms" }],
  }),
  component: TermsPage,
});
